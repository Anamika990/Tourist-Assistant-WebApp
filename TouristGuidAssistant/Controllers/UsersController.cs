...
namespace TouristGuidAssistant.Controllers
{
    ...
    {
        private TouristDbContext db = new TouristDbContext();
        ...
        public ActionResult Details(int? id)
        {
            ...
            Users users = db.Registrations.Find(id);
            if (users == null)
            {
                return HttpNotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "UserId,UserName,Email,Phone,NID,DateOfBirth,Address,Gender,UserType,Image,Password,confirmPassword")] Users users)
        {
            if (ModelState.IsValid)
            {
